...
const get_person_in_count = async (ts_start, ts_end, suppress_time) => {
  ...
  return await db_gate.allDocs({
    ...
    console.log('Count gate unique');
    console.log('res --- alldoc ---');
    console.log(res);
...
const get_gate_step_count = async (ts_start, ts_end, step_time) => {
  const g_map = new Map();
...
export { get_gate_step_count };
export { get_person_in_count };
